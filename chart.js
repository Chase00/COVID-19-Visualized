...
var svg = d3.select("svg"),
    ...
    marginBrush = { top: 430, right: 20, bottom: 30, left: 70 },
    width =+ svg.attr("width") - margin.left - margin.right,
    height =+ svg.attr("height") - margin.top - margin.bottom,
    heightBrush =+ svg.attr("height") - marginBrush.top - marginBrush.bottom;
...
// Load the data
d3.csv("owid-covid-data-US.csv", type, function (error, data) {
...
// Brush intereaction with the data timeline
function brushed() {
